...
from robot_lab.tasks.locomotion.velocity.velocity_stone_cfg import LocomotionVelocityStoneEnvCfg
...
@configclass
class UnitreeA1StoneEnvCfg(LocomotionVelocityStoneEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "UnitreeA1StoneEnvCfg":
